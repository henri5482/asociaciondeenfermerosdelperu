...
const benefitsData = [
  {
    id: 1,
    icon: "/images/icon-money-bag.png", // Reemplazar con tu ícono real (ej: Lucide icon o SVG)
  ...
  {
    id: 2,
    icon: "/images/icon-equipment.png", // Reemplazar con tu ícono real
...
const Beneficios = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 to-gray-950 text-white py-16 px-4 sm:px-8 lg:px-16">
      <motion.div
      ...
      >
        ...
        >
          <motion.div {...buttonHoverTap}>
            <Button
              size="lg"
              className="w-full sm:w-auto bg-yellow-400 hover:bg-yellow-500 text-slate-900 font-bold py-3 px-8 rounded-lg shadow-lg"
            >
              Comienza a enseñar
            </Button>
          </motion.div>
          <motion.div {...buttonHoverTap}>
            <Button
              variant="outline"
              size="lg"
              className="w-full sm:w-auto border-gray-500 text-gray-300 hover:bg-gray-700 hover:text-white font-bold py-3 px-8 rounded-lg shadow-lg transition-colors duration-300"
            >
