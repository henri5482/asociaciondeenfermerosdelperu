...
const Hero = () => {
  ...
  return (
    ...
    <div className="relative overflow-hidden bg-[#0f1e26] text-white pt-28 md:pt-40 pb-12 md:pb-24 px-6 md:px-12 lg:px-24 flex flex-col-reverse md:flex-row items-center justify-between gap-12 lg:gap-24 min-h-screen">
